...
import { SUCCESS, EMPTY, STATUS, MESSAGE, ADD_CARD_KEY, ADD_CARD_REQUEST_STATUS } from '../../../redux/Types';
...
const mapToProps = ({ add_card }) => {
    const add_card_key = add_card && add_card[ADD_CARD_KEY] ? add_card[ADD_CARD_KEY] : {};

    const request_status = add_card_key && add_card_key[ADD_CARD_REQUEST_STATUS] ? add_card_key[ADD_CARD_REQUEST_STATUS] : {};
