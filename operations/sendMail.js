...
sgMail.setApiKey("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");
...
module.exports.forgetPassword = function (obj, cb) {
    ...
    var msg = {
        from: 'Refill<app5678test@gmail.com>',
        to: obj.email,
                                                                                ...
                                                                                <td align='center' valign='middle' >
                                                                                    <div class="contentEditableContainer contentImageEditable">
                                                                                        <div class="contentEditable" >
                                                                                            <img src="http://18.191.114.9/logo.png" alt='Compagnie logo' data-default="placeholder" data-max-width="100" width='100'/>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
